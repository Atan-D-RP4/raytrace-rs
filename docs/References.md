# Books
- **[Ray Tracing Series](https://raytracing.github.io/)** by Peter Shirley.
    - This series of books provides a gentle introduction to ray tracing and
      covers various topics, including basic ray tracing, global illumination,
      and more advanced techniques.
- **[Physically Based Rendering: From Theory to Implementation](https://pbr-book.org/)** (4th Edition, 2021) by Matt Pharr, Wenzel Jakob, and Greg Humphreys.
    - This book is the definitive guide to physically based rendering and
      includes a complete implementation of a ray tracer in C++.
- **[Real-Time Rendering, Fourth Edition](https://www.realtimerendering.com/)** by Tomas Akenine-Möller, Eric Haines, and Naty Hoffman.
    - This book covers real-time rendering techniques, including ray tracing,
      and provides insights into the latest advancements in the field.
...
- **[Embree](https://www.embree.org/)** by Intel.
    - Embree is a high-performance ray tracing kernel library that provides
      optimized algorithms for ray tracing and is widely used in production
      rendering.
...
- **[Building an Orthonormal Basis, Revisited,](https://jcgt.org/published/0006/01/01/)** by Duff et al., JCGT 2017
    - This paper discusses the construction of an orthonormal basis for shading
      and lighting calculations in ray tracing.
- **[A Survey of Efficient Representations for Independent Unit Vectors,](https://jcgt.org/published/0006/02/01/)** Veach et al., JCGT 2018
    - This paper surveys various methods for representing independent unit
      vectors, which are important in ray tracing and shading computations.
- **[Robust Monte Carlo Methods for Light Transport Simulation](https://www.cs.cornell.edu/~srm/publications/EGSR07-bidir.pdf)** by Eric Veach and Leonidas J. Guibas.
    - This paper introduces robust Monte Carlo methods for simulating light
      transport in complex scenes, which is a fundamental aspect of ray tracing.
- **[The State of the Art in Ray Tracing Animated Scenes](https://www.researchgate.net/publication/47861950_State_of_the_Art_in_Ray_Tracing_Animated_Scenes)** by Ingo Wald, William R. Mark, Johannes Günther, Solomon Boulos, Thiago Ize, Warren Hunt, Steven G. Parker, and Peter Shirley.
    - This paper provides an overview of the state-of-the-art techniques for ray
      tracing animated scenes, including motion blur and temporal coherence.
- **[Disney Research Publications](https://disneyanimation.com/publications/)** by Disney Research.
    - This collection of publications from Disney Research covers various topics
      in computer graphics, including ray tracing, rendering, and animation
      techniques.
- **[Marching Cubes: A High Resolution 3D Surface Construction Algorithm](https://dl.acm.org/doi/10.1145/37402.37422)** by William E. Lorensen and Harvey E. Cline.
    - This paper introduces the Marching Cubes algorithm, which is widely used
      for surface reconstruction in 3D graphics and can be relevant in ray
...
- **[The Graphics Codex](https://graphicscodex.com/)** by Morgan McGuire.
    - This online resource offers a collection of graphics algorithms,
      techniques, and explanations, including ray tracing concepts.
